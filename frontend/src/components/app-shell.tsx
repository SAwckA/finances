  ...
  return (
    <div className={`mobile-page ${isEditorScreen ? "" : "pb-24"}`}>
      ...
      {!isEditorScreen ? (
        <motion.nav
          animate={{ opacity: 1, y: 0 }}
          className="nav-shell-surface fixed bottom-0 left-0 right-0 z-40 mx-auto w-full max-w-[430px] isolate rounded-t-[24px] px-3 pb-[calc(env(safe-area-inset-bottom)+0.45rem)] pt-2.5"
