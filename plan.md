...
- [ ] CP-3: Библиотека UI-компонентов собрана (этап 3)
- [ ] CP-4: Dashboard полностью переведен на новый дизайн (этап 4)
- [x] CP-5: Analytics экран запущен и заполнен данными (этап 5)
- [ ] CP-6: Transactions редизайн завершен (этап 6)
- [ ] CP-7: Accounts редизайн завершен (этап 7)
- [ ] CP-8: Categories редизайн завершен (этап 8)
- [x] CP-9: Settings hub завершен (этап 9)
- [ ] CP-10: Нереференсные экраны визуально выровнены (этап 10)
