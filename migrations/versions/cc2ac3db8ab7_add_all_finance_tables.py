...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_recurring_transactions_next_execution_date'), 'recurring_transactions', ['next_execution_date'], unique=False)
    ...
    sa.Column('account_id', sa.Integer(), nullable=False),
    sa.Column('category_id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('DRAFT', 'CONFIRMED', 'COMPLETED', name='shoppingliststatus'), nullable=False),
    ...
    op.create_index(op.f('ix_shopping_lists_deleted_at'), 'shopping_lists', ['deleted_at'], unique=False)
    ...
    op.create_table('shopping_templates',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=100), nullable=False),
    sa.Column('color', sa.String(length=7), nullable=False),
    ...
    op.create_index(op.f('ix_shopping_templates_deleted_at'), 'shopping_templates', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_shopping_templates_user_id'), 'shopping_templates', ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_shopping_items_deleted_at'), 'shopping_items', ['deleted_at'], unique=False)
    op.create_index(op.f('ix_shopping_items_shopping_list_id'), 'shopping_items', ['shopping_list_id'], unique=False)
    op.create_table('shopping_template_items',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_shopping_template_items_deleted_at'), 'shopping_template_items', ['deleted_at'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_shopping_template_items_deleted_at'), table_name='shopping_template_items')
    ...
    op.drop_index(op.f('ix_shopping_templates_user_id'), table_name='shopping_templates')
    op.drop_index(op.f('ix_shopping_templates_deleted_at'), table_name='shopping_templates')
    ...
    op.drop_index(op.f('ix_recurring_transactions_next_execution_date'), table_name='recurring_transactions')
